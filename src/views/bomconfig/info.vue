<template>
  <div class="bomInfo_container">
    <el-table :data="formattingData" style="width: 100%" row-key="name" height="500" :tree-props="{children: 'children', hasChildren: 'hasChildren'}">
      ...
      <el-table-column label="remark" min-width="40">
        <template slot-scope="scope">
          <span style="margin-left: 10px">{{ scope.row.remark }}</span>
        </template>
      </el-table-column>
      <el-table-column label="addDateTime" width="100">
        <template slot-scope="scope">
          <span style="margin-left: 10px">{{ scope.row.addDateTime }}</span>
        </template>
      </el-table-column>
      <el-table-column label="modifyDateTime" width="100">
        <template slot-scope="scope">
...
export default {
  ...
  data() {
    return {
      tableData: [
        { 
          material_code:"90586323",
          material_id:"53",
          material_name:"物料名称",
          material_info:"这是物料相关的信息",
          material_num:"这是物料数量",
          material_position:"物料位置",
          children: [{
            material_code:"90586324",
            material_id:"53",
            material_name:"物料名称",
            material_info:"这是物料相关的信息",
            material_num:"这是物料数量",
